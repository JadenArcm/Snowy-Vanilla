...
//  0--1
	...
	FBITFIELD BlendingFlag = HWR_GetBlendModeFlag(blendmode + 1);
	HWD.pfnDrawPolygon(&Surf, v, 4, PF_Modulated|PF_NoTexture|PF_NoDepthTest|PF_Translucent|BlendingFlag);
}
